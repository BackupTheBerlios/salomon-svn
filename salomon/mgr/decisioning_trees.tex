...
¿e zrozumienie go czy porównanie nie jest trudnym zadaniem. Drzewa decyzyjne
sta³y siê bardzo popularne w technikach data maning-u (\ref{lab:data_mining}). 
Drzewa decyzyjne s¹ najpowszechniej u¿ywane do klasyfikacji (predykuj¹ do której grupy nale¿y dany
