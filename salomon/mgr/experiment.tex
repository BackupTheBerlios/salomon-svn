...
Eksperyment ten zosta³ przeprowadzony z~wykorzystanie projektu zademonstrowanego w~rozdziale \ref{lab:experiment}. Przy pierwszym uruchomieniu projektu wygenerowane zosta³o drzewo decyzyjne (Rys. \ref{fig:agent_tree1}). 
...
Nastêpnie uruchomiony zosta³ agent nas³uchuj¹cy na zmiany w~danych i~za pomoc¹ zewnêtrznego po³¹czenia do bazy danych zosta³y dodane do niej nowe rekordy.
Po przekroczeniu zdefiniowanej w~konfiguracji agenta iloœci nowych danych, zadania w~obrêbie projektu zosta³y automatycznie przeliczone ponownie, o~czym œwiadczy zmieniony licznik uruchomieñ projektu. Zosta³y one uruchomione po raz kolejny w~oparciu o~nowe dane, czego wynikiem by³o nowe drzewo decyzyjne (Rys. \ref{fig:agent_tree2})
