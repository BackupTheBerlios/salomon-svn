...
które nadzoruje obliczenia uczenia maszynowego oraz u³atwia proces tworzenia algorytmów (w~postaci wtyczek). Przyk³adowe wykorzystanie systemu obejmuje zbudowanie oraz wizualizacjê drzewa decyzyjnego na podstawie zbioru danych ucz¹cych.
 
\section{Opis problemu}

Mo¿liwoœci systemu zostan¹ zaprezentowane na przyk³adzie budowy drzewa decyzyjnego w~oparciu o~zbiór atrybutów. Atrybuty te definiuj¹ w~jaki sposób interpretowany
...
danych wejœciowych i~w przyjêtym w~systemie podejœciu (por. \ref{lab:knowledge})
bazuj¹ na zbiorach danych. St¹d wtyczka tworz¹ca zbiór atrybutów -- \emph{AttributeSetCreator},
...
\begin{figure}[H]
	...
	\caption{Rezultat pracy algorytmu}
