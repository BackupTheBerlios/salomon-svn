...
W dalszej czêœci rozdzia³u zaprezentowano wtyczki, które zosta³y u¿yte do realizacji poszczególnych etapów eksperymentu.
...
Celem kolejnego eksperymentu, jest zademonstrowanie dzia³ania agentów.
...
Eksperyment ten zosta³ przeprowadzony z wykorzystanie projektu zdefiniowanego
w ramach wczeœniejszego eksperymentu. Przy pierwszym otwarciu projektu
zosta³o wygenerowane drzewo decyzyjne rys. WSTAWIÆ! Nastêpnie za 
Za pomoc¹ zewnêtrznego po³¹czenia do bazy danych zosta³y dodane do niej
nowe rekordy. Po przekroczeniu zdefiniowanego procentowego progu zdefiniowanego
w konfiguracji agenta ref... Zadania zosta³y uruchomione po raz
kolejny w oparciu o nowe dane, czego wynikiem by³o nowe drzewo decyzyjne rys.


%Elementem systemu pozwalaj¹cym na obs³ugê zdarzeñ s¹ agenci.
%W tym celu zosta³ napisany agent \emph{DataIncreaseAgent}, który
%okresowo sprawdza bazê danych w celu wykrycia dostêpnoœci nowych danych.
%Jeœli iloœæ nowych danych przekroczy pewien próg projekt jest przeliczany na
%nowo.
