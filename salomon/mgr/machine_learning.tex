...
wynalezienia komputerów. Gdyby uda³o siê zrozumieæ w jaki sposób
tworzyæ programy, które mog³yby automatycznie ulepszaæ siê bazuj¹c
na doœwiadczeniu, ich wp³yw na wszelkie dziedziny ¿ycia by³by ogromny.
Mo¿na sobie wyobraziæ programy ucz¹ce siê na podstawie danych z kartotek
medycznych, jaki rodzaj leczenia jest najbardziej efektywny dla nowych chorób,
automatycznie sterowane domy, które optymalizowa³yby koszty zu¿ycia egergii
na podstawie wzorców zachowañ poszczególnych mieszkañców, czy osobistego asystenta,
który uczy³by siê na podstawie rozwijaj¹cych siê zainteresowañ u¿ytkowników,
w jakiej kolejnoœci prezentowaæ codzienne wiadomoœci z porannej gazety.
Zrozumienie w jaki sposób projektowaæ programy ucz¹ce siê nie tylko znacznie
poszerzy³oby kr¹g u¿ytkowników komputerów, ale tak¿e mog³oby prowadziæ
...
rozwi¹zania. Tak¿e w dziedzinie \emph{data miningu}~(\ref{lab:data_mining})
algorytmy te s¹ czêsto u¿ywane do pozyskiwania wiedzy z ogromnych baz danych
zawieraj¹cych dane medyczne, finansowe czy wyniki eksperymentów naukowych.
...
rozwija i nieuchronnie zaczyna pe³niæ coraz bardziej znacz¹c¹ rolê wœród technologii komputerowych.
