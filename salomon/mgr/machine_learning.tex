...
%Cichosz (35-36)
\subsection{Algorytmy ucz¹ce siê}
...
% Cichosz 40
\subsection{Zastosowanie algorytmów ucz¹cych}
...
%Troche przykladow
% Cichosz 41-42
Wiedza z punktu widzenia algorytmów ucz¹cych mo¿e byæ przechowywana na ró¿ne
...
logiki predykatów, wykorzystuje siê tak¿e rozk³ady prawdopodobieñstwa oraz
automaty skoñczone.

\subsection{Metody reprezentacji wiedzy}

Jednym z podzia³ów metod reprezentacji wiedzy jest rozró¿nienie miêdzy metodami
\emph{symbolicznymi} i \emph{subsymbolicznymi}.
Metody symboliczne do reprezentacji wiedzy stosuj¹ struktury przechowywuj¹ce
informacje o chartakterze symbolicznym, czyli pewne napisy, które mog¹ byæ w
pewien sposób interpretowane. Napisy te najczêœciej maj¹ formê czyteln¹ dla
cz³owieka i mog¹ byæ przez niego przegl¹dane i poddawane analizie i
interpretacji. 
...
jedynym mo¿liwym sposobem jej przedstawienia, jednak rzadko zdarza siê, by wybór
metody by³ szeroki. Wynika to z tego, ¿e sposób, w jaki wiedza mo¿e byæ u¿yta
...
polega na odzworowaniu obiektów na zbiór liczb rzeczywistych.
...
Algorytmy uczenia maszynowego mo¿na podzieliæ ze wzglêdu na sposób weryfikacji
uzyskiwanej w procesie uczenia siê wiedzy. Takie kryterium prowadzi do podzia³u
na \emph{uczenie siê z nadzorem} i \emph{bez nadzoru}.
...
Uczenie z nauczecielem i bez nadzoru to najbardziej popularne grupy algorytmów,
...
Jednym z g³ównych zastosowañ systemów ucz¹cych jest ich wykorzystanie do
wydobywania wiedzy z baz danych. W du¿ych systemach informatycznych
przechowywane s¹ niewyobra¿alne iloœci danych i potrzebne s¹ narzêdzia
wspomagaj¹ce ich efektywne przetwarzanie. W odró¿nieniu od zwyk³ych systemów
pozwalaj¹cych na przeszukiwanie danych, systemy ucz¹ce pozwalaj¹ dodatkowo na
analizê tych danych poprzez znajdowanie zwi¹zków i zale¿noœci miedzy nimi, co
prowadzi do pozyskania dodatkowej wiedzy, nie zapisanej bezpoœrednio w danych.
...
Metody uczenia maszynowego wykorzystywane s¹ na przyk³ad przez chemików do
wyszukiwania ukrytych regularnoœci w zbiorach danych analitycznych oraz 
do prognozowania wybranych w³aœciwoœci zwi¹zków organicznych.
...
Najwieksz¹ baz¹ danych jest dziœ Internet. Trudno wyobraziæ sobie 
¿ycie bez wyszukiwarek, które musz¹ analizowaæ ogromne iloœci danych oraz
potrafiæ wyszukaæ zale¿noœci miêdzy nimi. To tak¿e jest obszar, w którym
znajduj¹ zastosowanie systemy ucz¹ce.

\subsubsection{Inteligentne maszyny TODO:}
