...
oraz uruchamianie ró¿nych algorytmów machine learning.
...
platformy, czyli np. przechowywania i~dostêpu do danych czy kwestii komunikacji
...
Przyk³adowo w~Wece zbiór danych jest podzbiorem zbioru atrybutów. 
W proponowanym podejœciu zbiór danych nie bêdzie wymaga³ kopiowania danych 
z zewnêtrznego Ÿród³a, a~jedynie definiowa³ przepis na utworzenie takowego 
