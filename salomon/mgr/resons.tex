...
Po przeanalizowaniu obecnie dostêpnych narzedzi do uczenia maszynowego
...
stworzenie w³¹snej implementacji. 

W dobie Internetu, coraz wiêcej aplikacji pracuje w œrodowisku rozproszonym.
Znana nam wersja systemu Vinlen nie posada³a mo¿liwoœci pracy w œrodowisku
...
oraz dostêp do roproszonych danych oraz wiedzy.

Vinlen jest rozwijany na uniwerystecie TUTAJ WSTAWIÆ NAZWÊ jako zamkniêty
produkt. My jednak postanowiliœmy udostêpniæ nasz system na otwartej licecji
...
racji na jej licencjê (GNU). Weka dostarcza implementaci wielu popularnych
...
zyskamy dostêp do jej bogatej bibioteki gotowych algorytmów. Vinlen ko¿ysta z
w³asnych implemtancji algorytmów, z których czêœæ powsta³a na uniwersytecie !!!!!.
