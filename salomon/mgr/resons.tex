...
\subsection{Jeszcze nie znam tytulu}
...
\begin{enumerate}
\item Osoby, które zajmuj¹ siê machine learning, niekoniecznie musz¹, byæ 
specjalistami od jêzyków programowania, dlatego 
...
stawianych wtyczkom. Inn¹ u¿yteczn¹ w³aœciwoœci¹, któr¹ nale¿y rozwa¿yæ jest 
umo¿liwienie tworzenia wtyczek za pomoc¹ jêzyków skryptowych. Jest to 
szczególnie po¿yteczna w³aœciwoœæ w przypadku, kiedy pracujemy nad danym 
algorytmem i dokonujemy eksperymentów, a przez co potrzebujemy czêsto modyfikowaæ 
...
szczególn¹ uwagê, aby nasza aplikacja by³a prosta w obs³udze (z ang. \emph{user 
friendly}) zarówno dla twórcy wtyczek jak i osoby wykonuj¹cej eksperymenty z 
...
Jak wczeœniej by³o napisane, system powinien dostarczaæ pewnego 
wspólnego API. W tym punkcie chcielibyœmy szczególnie zwróciæ uwagê na API 
pozwalaj¹ce na dokonywanie operacji na wiedzy oraz danych. Taki interfejs w 
...
algorytmów (wtyczek) od zapisu/odczytu danych pozwala równie¿ zapewniæ 
...
(np. w postaci zapytania, stanowi¹cego zbiór warunków). Wa¿ne jest, aby dostêpne by³y 
operacje na zbiorach, takie jak suma czy przeciêcie. Przyk³adowo chcielibyœmy 
...
u¿ytkownikowi na manipulacje na ju¿ gotowym zbiorze (np. wygenerowanym przez 
system, albo przez algorytm klastruj¹cy). 

Niestety wiêkszoœæ algorytmów wymaga 
...
,,surowych'' danych z bazy do danych wejœciowych dla algorytmu nazywamy 
atrybutami. Dla u¿ytkownika proces stworzenia atrybutów z wszystkich danych 
zgromadzonych w zewnêtrzne bazie danych i z danych z data setu powinien 
