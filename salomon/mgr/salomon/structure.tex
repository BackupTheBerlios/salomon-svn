...
te¿ pojedynczego, bazuj¹c na unikalnym identyfikatorze.
...
Zarz¹dza zadaniami. Jego zadaniem jest nie tylko umo¿liwienie utworzenia 
lub edycji istniej¹cych zadañ, ale tak¿e nadzorowanie ich uruchamiania.
...
Po dodaniu warstwy \emph{Solution} kontroler ten musi zostaæ zmodyfikowany, 
co planowane jest w nastêpnej wersji systemu.
