...
Wszystkie menad¿ery, którymi zarz¹dza maj¹ analogiczn¹ funkcjonalnoœæ -- ka¿dy z
...
Udostêpnia obiekt implementuj¹cy interfejs \emph{IMetaData}, dziêki któremu
...
W obecnej wersji systemu jest on nie zaimplementowany.
...
%
%Poni¿y diagram \ref{fig:plugin_uml} przedstawia podstawowe interfejsy
...
%Programista ma do~dyspozycji typy proste, typ tablicowy, oraz struktury.
...
Zdarzenie mo¿e byæ zewnêtrzne takie jak przyk³adowo pojawienie siê nowych
danych w~œrodowisku (zmiana w~zewnêtrznej bazie danych). Rozró¿niamy te¿
zdarzenie wewnêtrzne, które zachodzi kiedy w~wyniku pracy innego agenta
w systemie pojawi³a siê nowa wiedza. Ostatnim rodzajem zdarzenia jest
zdarzenie niezale¿ne, jakim jest zdarzenie zegarowe.
