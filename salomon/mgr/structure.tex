System, który jest realizacj¹ przedstawionej w poprzednim rozdziale koncepcji, dziêki swej elastycznej architekturze, pozwala u¿ytkownikowi na 
...
drzewach decyzyjnych odpowiednio za pomoc¹ interfejsów \emph{IDataSetManager} (\ref{lab:datasets}), \emph{IAttributeManager} (\ref{lab:attributes}) i \emph{ITreeManager} (\ref{lab:trees}).
