...
okreœlonego obiektu \emph{ISolution} (por. \ref{lab:project}) .

\paragraph{ITaskManager}

Interfejs ten dostarcza funkcjonalnoœci umo¿liwiaj¹cej zarz¹dzanie zadaniami (por. \ref{lab:tasks}) dla konkretnego projektu. Oprócz standardowych operacji wspólnych dla wszystkich menad¿erów, jego zadaniem jest tak¿e zapewnienie poprawnej konfiguracji, nadzór nad wykonaniem oraz zachowanie informacji
