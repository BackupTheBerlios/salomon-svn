...
CREATE TABLE TREE_DATA_SOURCES (
    ...
    TDS_FIRST_ROW INTEGER NOT NULL,
    TDS_LAST_ROW INTEGER NOT NULL,
...
DESCRIBE FIELD TDS_FIRST_ROW TABLE TREE_DATA_SOURCES 'first row index';
DESCRIBE FIELD TDS_LAST_ROW TABLE TREE_DATA_SOURCES 'last row index';
