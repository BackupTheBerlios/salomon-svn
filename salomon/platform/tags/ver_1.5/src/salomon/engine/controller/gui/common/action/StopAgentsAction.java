 ...
 * 
 */
public class StopAgentsAction extends AbstractProjectAction
{

    protected StopAgentsAction(ProjectManagerGUI projectEditionManager)
    {
    ...
    {
        _projectEditionManager.stopProjectAgents();
    }
