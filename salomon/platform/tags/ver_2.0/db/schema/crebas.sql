...
ALTER TABLE AGENT_CONFIG ADD CONSTRAINT PK_AGENT_CONFIG PRIMARY KEY (CONFIG_ID);
...
ALTER TABLE AGENT_CONFIG ADD CONSTRAINT FK_AGENT_CONFIG_AGENT FOREIGN KEY (AGENT_ID) REFERENCES AGENTS (AGENT_ID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE AGENT_CONFIG ADD CONSTRAINT FK_AGENT_CONFIG_PROJECT FOREIGN KEY (PROJECT_ID) REFERENCES PROJECTS (PROJECT_ID) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE PROJECTS ADD CONSTRAINT UNQ_PROJECT_NAME UNIQUE (PROJECT_NAME);

ALTER TABLE AGENTS ADD CONSTRAINT UNQ_AGENT_NAME UNIQUE (AGENT_NAME);

ALTER TABLE DATASETS ADD CONSTRAINT UNQ_DATASET_NAME UNIQUE (DATASET_NAME);

ALTER TABLE ATTRIBUTESETS ADD CONSTRAINT UNQ_ATTRIBUTESET_NAME UNIQUE (ATTRIBUTESET_NAME);

ALTER TABLE TREES ADD CONSTRAINT UNQ_TREE_NAME UNIQUE (TREE_NAME);
...
CREATE GENERATOR GEN_AGENT_CONFIG_ID;
