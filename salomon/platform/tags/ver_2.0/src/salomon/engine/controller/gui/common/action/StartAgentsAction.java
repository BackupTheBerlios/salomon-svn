 ...
 * 
 */
public class StartAgentsAction extends AbstractProjectAction
{

    protected StartAgentsAction(ProjectManagerGUI projectEditionManager)
    {
    ...
    {
        _projectEditionManager.startProjectAgents();
    }
