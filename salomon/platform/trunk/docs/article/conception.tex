...
\begin{itemize}
    ...
    \emph{VINLEN} to gotowy produkt, dostarczany z razem ró¿nymi algorytmami.
     \emph{Salomon} to otwarta platforma, która ma stanowiæ bazê podaczaæ tworzenia produktów wykorzystuj¹cych \emph{Machine Lerning}
     w procesie odkrywania wiedzy z danych. St¹d za³o¿enie: Platforma -- g³ówny modu³ systemu jest tak prosty jak to mo¿liwe. Jego zadaniem jest dostarczenie
    ...
    \item Prostota u¿ytkownia
    £atwoœæ u¿ytkowania to jeden z fundametów systemu \emph{VINLEN}. \emph{Salomon} stara równie¿ pod tym wzglêdem
    dorównaæ a nawet przeœcign¹c swojego protoplastê. System znajduje siê, jeszcze we wstepnej fazie rozwoju, wiêc,
    ciê¿ko dokonywaæ porównañ. Jedn¹ z wa¿niejszych u³atwieñ jest zast¹pienie jêzyka definiowania skautów modelem graficznym (grafem przep³uwu wiedzy).
