...
\end{itemize}
Celem tego projektu jest stworzenie przyjaznego œrodowiska do tworzenia, kontrolowania i efektywnego wykonywania zadañ.

Salomon siê on z dwóch zasadniczych czêœci - pierwsz¹ z nich
