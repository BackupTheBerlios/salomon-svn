...
%\usepackage[MeX]{polski}		 %pakiet ustawiajacy jezyk polski podobno idealnie
\usepackage{amsfonts}				 %czcionki dla labelek
...
Poni¿szy diagram przedstawia punkt widzenia u¿y\-tko\-wnika:\\
\begin{figure}
	\centering
...
\end{figure}
U¿y\-tkownik wybiera najpierw tzw. \textit{plugin wej¶ciowy}, okre¶la jego konfiguracjê. U¿y\-tkownik wybiera zdefiniowane wcze¶niej dla obecnego solution`a dane wej¶ciowe lub  nowe poprzez zdefiniowanie nazwy danych wej¶ciowych (dla pó¼niejszej identyfikacji),\linebreak
