...
public final class AttributeManager implements IAttributeManager
{
            ...
            String type, boolean isOutput) throws PlatformException
    {
        ...
        if (type != null) {
            ...
            ((AttributeDescription) description).setOutput(isOutput);
        }
        return description;
    }
            ...
            throws PlatformException
    {
        ...
        select.addColumn("ai.is_output");
        //FIXME:
        // the value of enum type is not read! it is always regenerated by accessing the solution's database
        // it should be taken from the 'value' column
