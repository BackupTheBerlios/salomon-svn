...
public class NodeTest extends TestCase
{
    ...
    private Node testNode1, testNode2, testNode3, testNode4, testNode5,
    ...
    {
        Node tempNode6 = new Node(1, null, "Temp node 6", Node.Type.VALUE,
                "test");
        Node tempNode7 = new Node(2, tempNode6, "Temp node 7", Node.Type.VALUE,
                "abc");
        Node tempNode8 = new Node(3, tempNode6, "Temp node 8",
    ...
    public void testNodeINodeStringTypeString()
    {
        ...
        Node tempNode7 = new Node(tempNode6, "Temp node 7", Node.Type.VALUE,
                "abc");
        Node tempNode8 = new Node(tempNode6, "Temp node 8", Node.Type.COLUMN,
                "123456");
    ...
    public void testAddChildren()
    {
        ...
        Node testArray[];
        List<Node> testList = new ArrayList<Node>(Arrays.asList(testNode1,
                testNode2, testNode3));
    ...
    public void testGetId()
    {
        ...
        Node testChild1 = new Node(256 * -256, null, "Rodzic", Node.Type.VALUE,
                "1");
