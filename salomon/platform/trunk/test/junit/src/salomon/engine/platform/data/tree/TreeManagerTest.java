...
//        _externalDBManager.connect(null, "db//TREEDECISIONINGDATA.GDB",
//                "SYSDBA", "masterkey");
//
...
//    {
//        ITreeNode testNode1 = new TreeNode(null, "Node1", Node.Type.VALUE, "1");
//        ITreeNode testNode2 = new TreeNode(null, "Node2", Node.Type.VALUE, "1->2");
//        ITreeNode testNode3 = new TreeNode(null, "Node3", Node.Type.VALUE, "1->3");
//        ITreeNode testNode4 = new TreeNode(null, "Node4", Node.Type.VALUE, "2->4");
//        ITreeNode testNode5 = new TreeNode(null, "Node5", Node.Type.VALUE, "2->5");
//
//        Tree testTree;
//
//        testTree = new Tree();
...
//            LOGGER.debug("treeArray[treeArray.length - 1].getInfo() :"
//                    + treeArray[treeArray.length - 1].getInfo());
//
//            assertTrue(treeArray[treeArray.length - 1].getInfo().compareTo(
//                    "Informacja") == 0);
//            assertTrue(treeArray[treeArray.length - 1].getName().compareTo(
//                    "Drzewko testowe") == 0);
//            LOGGER.debug("treeArray[treeArray.length - 1].getId():"
//                    + treeArray[treeArray.length - 1].getId());
//            assertTrue(treeArray[treeArray.length - 1].getId() == treeID);
//            assertTrue(treeArray[treeArray.length - 1].getRoot().getValue().compareTo(
//                    testNode1.getValue()) == 0);
//            assertTrue(treeArray[treeArray.length - 1].getRoot().getChildren()[0].getValue().compareTo(
//                    testNode2.getValue()) == 0);
//            assertTrue(treeArray[treeArray.length - 1].getRoot().getChildren()[1].getValue().compareTo(
//                    testNode3.getValue()) == 0);
//            assertTrue(treeArray[treeArray.length - 1].getRoot().getChildren()[0].getChildren()[0].getValue().compareTo(
//                    testNode4.getValue()) == 0);
//            assertTrue(treeArray[treeArray.length - 1].getRoot().getChildren()[0].getChildren()[1].getValue().compareTo(
//                    testNode5.getValue()) == 0);
//
//            assertTrue(treeArray[treeArray.length - 1].getDataSource().getDecisionedColumn().compareTo(
//                    "KOLUMNA_DECISIONED") == 0);
//            assertTrue(treeArray[treeArray.length - 1].getDataSource().getInfo().compareTo(
//                    "TEST_ADD_TREE") == 0);
//            assertTrue(treeArray[treeArray.length - 1].getDataSource().getName().compareTo(
//                    "NAZWA TESTOWA DATASOURCEA") == 0);
//            assertTrue(treeArray[treeArray.length - 1].getDataSource().getTableName().compareTo(
//                    "FIKCYJNA_TABELA") == 0);
//            LOGGER.debug("treeArray[treeArray.length - 1].getDataSource().getDecioningColumns()[0]:"
//                    + treeArray[treeArray.length - 1].getDataSource().getDecioningColumns()[0]);
...
//            assertEquals(receivedTree.getRoot().getValue(),
//                    testTree.getRoot().getValue());
