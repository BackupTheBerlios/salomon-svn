...
public class CreatorResultComponent implements IResultComponent
{
    ...
    {
        _txtAttributeSetName = new JTextField();
    }
    ...
    public Component getComponent(IResult result, IDataEngine dataEngine)
    {
        ...
        _txtAttributeSetName.setText(cResult.getAttributeSetName());
    ...
    private JComponent createResultComponent()
    {
        ...
        panel.add(new JLabel("Attribute set name"));
        _txtAttributeSetName.setPreferredSize(new Dimension(100, 20));
        _txtAttributeSetName.setEditable(false);
        panel.add(_txtAttributeSetName);
