 ...
 * @author nico
 */
public class RandomDSResultComponent implements IResultComponent
{
	private JComponent _resultComponent;

	private JTextField _txtDataSetName;

	public RandomDSResultComponent()
	{
	...
	public Component getComponent(IResult result, IDataEngine dataEngine)
	{
		...
		RandomDSResult cResult = (RandomDSResult) result;
		SimpleString dataSetName = (SimpleString) cResult.getField(RandomDSResult.DATA_SET_NAME);
